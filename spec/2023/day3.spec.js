describe("day3", () => {
    ...
    describe("Part 1", () => {
        it("Should creatAdjacentDictForLookup - Sample", () => {
            let smallerSample = [
               //0123456789 
                '467..114..',
                '...*......',
            ...
            //don't care if it goes "off the map". It's just extra data I won't use later,no index out of bound risk
                '4,5': true, 
                '4,6': true,
                '4,7': true,
            }

            expect(creatAdjacentDictForLookup(smallerSample)).toEqual(expectedDictionary);
        });

        it("Should sumAdjacentToSymbols - Sample", () => {
            expect(sumAdjacentToSymbols(sample)).toEqual(4361);
        });

        it("Should handle 20 - Sample", () => {
            let problemcase = [
                '*20'
            ]
            expect(sumAdjacentToSymbols(problemcase)).toEqual(20);
        });

        it("Should sumAdjacentToSymbols - Actual", () => {
            expect(sumAdjacentToSymbols(actual)).toEqual(544664); 
            //528661553469 is too high - which, yeah, that feels like something went wrong
            //454549 is too low
        });
