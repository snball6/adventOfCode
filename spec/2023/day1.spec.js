describe("day1", () => {
    ...
    describe("Part 1", () => {
        it("Should return first and last digit in a string - Sample", () => {
            expect(getFirstLast(sample1[0])).toBe(12);
            expect(getFirstLast(sample1[1])).toBe(38);
            expect(getFirstLast(sample1[2])).toBe(15);
            expect(getFirstLast(sample1[3])).toBe(77);
        });

        it("Should sum calibration values - Sample", () => {
            
            expect(getFirstPuzzleResult(sample1)).toBe(142);
        });

        it("Should sum calibration values - Actual", () => {
            expect(getFirstPuzzleResult(actual)).toBe(54968);
        });
    });

    describe("Part 2", () => {
        it("Should return first and last digit in a string - Sample", () => {
            expect(getFirstLastPart2(sample2[0])).toBe(29);
            expect(getFirstLastPart2(sample2[1])).toBe(83);
            expect(getFirstLastPart2(sample2[2])).toBe(13);
            expect(getFirstLastPart2(sample2[3])).toBe(24);
            expect(getFirstLastPart2(sample2[4])).toBe(42);
            expect(getFirstLastPart2(sample2[5])).toBe(14);
            expect(getFirstLastPart2(sample2[6])).toBe(76);
        });

        it("Should return first and last digit in a string - problem rows when spot checking", () => {
            expect(getFirstLastPart2('44qcrkvr1two')).toBe(42);
            expect(getFirstLastPart2('one')).toBe(11);
            expect(getFirstLastPart2('two')).toBe(22);
            expect(getFirstLastPart2('three')).toBe(33);
            expect(getFirstLastPart2('four')).toBe(44);
            expect(getFirstLastPart2('five')).toBe(55);
            expect(getFirstLastPart2('six')).toBe(66);
            expect(getFirstLastPart2('seven')).toBe(77);
            expect(getFirstLastPart2('eight')).toBe(88);
            expect(getFirstLastPart2('nine')).toBe(99);
        });


        
        it("Should sum calibration values - Actual", () => {
            expect(getSecondPuzzleResult(actual)).toBe(54094);
        });
    });
