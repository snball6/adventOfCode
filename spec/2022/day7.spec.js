describe("day7", () => {
    ...
    describe("Part 1", () => {
        it("Helper - it should buildFileStructure", () => {
            ...
            expect(directoryD.totalFileSize).toEqual(24933642);
            let directoryE = directoryA.childDirectories[0]['e'];
            expect(directoryE.totalFileSize).toEqual(584);

        });

        it("Sample - should total directories with less than 100,000", () => {
